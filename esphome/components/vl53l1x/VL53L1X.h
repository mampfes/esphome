...
class VL53L1X {
 public:
  ...
  uint16_t read_range_single_millimeters(bool blocking = true) {
    return read_single(blocking);
  }  // alias of readSingle()
 ...
 protected:
  ...
  bool check_timeout_expired_() {
    return (io_timeout_ > 0) && ((uint16_t)(millis() - timeout_start_ms_) > io_timeout_);
  }
